...
const Hero: React.FC<HeroProps> = ({ onFileSelect }) => {
    return (
        <section className="relative py-16 sm:py-24 text-center bg-white overflow-hidden">
            ...
            <div className="container mx-auto px-4 md:px-8 relative">
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 mt-4">
