...
const ImageViewer: React.FC<ImageViewerProps> = ({ imagePreview, file }) => {
    return (
        <div className="w-full flex-grow bg-slate-100 rounded-lg p-4 flex items-center justify-center min-h-[200px] border border-slate-200">
            {imagePreview ? (
                ...
                <div className="text-center text-slate-500">
                    ...
                    <p className="text-sm text-slate-400">PDF document loaded</p>
                </div>
            ) : (
                <div className="text-center text-slate-500">
