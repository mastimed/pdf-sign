...
const Header: React.FC = () => {
    ...
    return (
        <header className={`sticky top-0 z-40 w-full backdrop-blur flex-none transition-colors duration-500 ${isScrolled ? 'bg-white/80 border-b border-slate-200' : ''}`}>
            <div className="container mx-auto px-4 md:px-8">
                <div className="relative flex items-center h-16">
                    ...
                    <div className="flex items-center">
                        <button className="ml-4 hidden sm:inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            Get Started
                        </button>
                    </div>
                </div>
